 ...
 */
static char *font ="Firacode nerd font mono:pixelsize=15.1:antialias=true:autohint=true";
/* Spare fonts */
static char *font2[] ={"Noto Sans Jp:pixelsize=16:antialias=true:autohint=true"};
...
static Shortcut shortcuts[] = {
   ...
   { TERMMOD,              XK_K,           kscrollup,      {.i = +1.5}},
   { TERMMOD,              XK_J,           kscrolldown,    {.i = +1.5}},
